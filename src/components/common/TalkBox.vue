...
<div class="oneforall">
    ...
    <div class="messagebox">
        ...
        <div style="display:flex;flex-direction: column;">
            ...
            <div v-if="talk" class="input-box">
                <!-- <el v-model="inputdata"/>
                <a @click="sendClick(inputdata)"></a> -->
                <el-input placeholder="请输入内容" v-model="inputdata">
                    <!-- <a slot="append" @click="sendClick(inputdata)"></a> -->
                    <el-button slot="append" @click="sendClick(inputdata)">发送</el-button>
                </el-input>                
            </div>             
        </div>
