<template>
    <div class="box">
        <div class="panel textboxcontainer">
            <div class="textbox" v-for="(v,i) in data" :key="i">
                <div class="text-t">
                    <p class="f16 text-info"><i class="iconfont"></i>{{v.title}}</p>
                    <h3 class="f24" v-countup='{startvalue:0,endvalue:parseInt(v.num)}'></h3>
                </div>
                <div class="text-c">
                    <div>
                        <p class="f14 text-info">{{v.lefttitle}}</p>
                        <h4 class="f18">{{v.lfetnum}}</h4>
                    </div>
                    <div class="line"></div>
                    <div>
                        <p class="f14 text-info">{{v.righttitle}}</p>
                        <h4 class="f18">{{v.rightnum+'%'}}</h4>
                    </div>
                </div>
            </div>
        </div>
...
.textboxcontainer>div:nth-last-child(1) {
        margin: 0;
    }
.text-t {
    padding-top: 20px;
